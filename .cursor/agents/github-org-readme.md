...
description: Especialista em README de exibição da organização no GitHub. Usar ao criar ou editar README.md do perfil da organização, ao aplicar layout (logo, resumo, footer) ou ao revisar conteúdo. Aplica .cursor/rules/org-readme-github.mdc, .cursor/skills/org-readme-layout/SKILL.md e .cursor/skills/conventional-commit-pt/SKILL.md (para mensagens de commit).
---
...
2. **Layout e estrutura** (passo a passo): Ler e aplicar `.cursor/skills/org-readme-layout/SKILL.md`.
   - Logo no topo, centralizada, em `assets/logo/` (usuário escolhe *notext ou *text), largura 200px, bordas arredondadas.
...
4. **Saída**: Propor ou editar o conteúdo do README de forma a atender regra e skill. Se o usuário pedir passo a passo, explicar usando as seções e o checklist da skill.
...
Sempre preferir ler os arquivos da regra e das skills para que sua saída siga os padrões atuais do projeto. Se o usuário escolher logo com ou sem texto, usar o caminho correto em `assets/logo/` e o nome de arquivo adequado (ex.: logo-notext.png ou logo-text.png).
